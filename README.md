...
| | Checklist de Análise de Riscos e Defensabilidade em IA | Identifica, avalia e planeja a mitigação de riscos relacionados à segurança, ética, privacidade, justiça e transparência da solução de IA. | [Link](./templates/AI_Risk_Analysis_and_Defensibility_Checklist.md) | [Link](./examples/AI_Risk_Analysis_and_Defensibility_Checklist_Example.md) |
